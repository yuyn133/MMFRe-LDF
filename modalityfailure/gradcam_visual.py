...
parser.add_argument('--model-path', type=str, default="/home/yyn/Desktop/fusiondegrade/runs/train.exp13/best.pt", help='Path to the model')
parser.add_argument('--source1', type=str, default='/home/yyn/Desktop/FLIR/visible/test', help='source')  # file/folder, 0 for webcam
parser.add_argument('--source2', type=str, default='/home/yyn/Desktop/FLIR/infrared/test', help='source')  # file/folder, 0 for webcam
parser.add_argument('--output-dir', type=str, default='/home/yyn/Desktop/gradcam/FLIR/', help='output dir')
...
if __name__ == '__main__':
    if os.path.isdir(args.source1):
        ...
        for item in img_vis_list[1127:]:
            ...
            if args.source1 == '/home/yyn/Desktop/FLIR/visible/test':
