...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='../models/fusiondegrade/yolov5l_infusion_FLIR.yaml', help='model.yaml')
    parser.add_argument('--device', default='0', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    opt = parser.parse_args()
    opt.cfg = check_file(opt.cfg)  # check file4
    set_logging()                         
