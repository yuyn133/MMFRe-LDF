...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./models/fusiondegrade/resnet50_infusion_FLIR.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='./data/multispectral-yyn/FLIR_aligned.yaml', help='data.yaml path')
